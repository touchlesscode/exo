...
import { Avatar, Bottom, Container, Logo, NavItems, Top } from './index.styled';
...
const Navigation = ({ onUpload, onDownload }: NavigationProps) => {
    ...
    return (
        <Container>
            ...
            <NavItems>
                <button onClick={onDownload} title="Download configuration">
                    <DownloadIcon width={20} height={20} fill={theme.colors.backgrounds.white} />
                </button>
                <button onClick={onUpload} title="Upload configuration">
                    <UploadIcon width={20} height={20} fill={theme.colors.backgrounds.white} />
                </button>
            </NavItems>
            <Bottom>
