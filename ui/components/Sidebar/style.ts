...
export const SidebarWrapper = styled.div<SidebarWrapperProps>`
	...
	z-index: ${(props) => props.theme.sideBarZIndex || 111};
	height: 100vh;
    background-color: ${(props) => (props.theme.themeType === "dark" ? props.theme.darkThemeSecondaryColor : props.theme.colors["primary-dark"] || "white")};
